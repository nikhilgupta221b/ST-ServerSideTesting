...
import ViewUserProfile from '../../components/ViewUserProfile';
import userContext from '../../context/userContext';
import { getUser, updateUser } from '../../services/user-service'; // Ensure you have an updateUser function in your user-service
...
function ProfileInfo() {
  ...
  return (
    <Base>
      <Row>
        <Col md={{ size: 6, offset: 3 }}>
          <Container>{updateFlag ? updateUserProfile() : viewUserProfile()}</Container>
        </Col>
      </Row>
    </Base>
  );
